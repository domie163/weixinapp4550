<template>
  <div class="addEdit-block">
    ...
    >
      <el-row >
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="书籍名称" prop="shujimingcheng">
          <el-input v-model="ruleForm.shujimingcheng" 
              placeholder="书籍名称" clearable  :readonly="ro.shujimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="书籍名称" prop="shujimingcheng">
              <el-input v-model="ruleForm.shujimingcheng" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="书籍分类" prop="shujifenlei">
          <el-select :disabled="ro.shujifenlei" v-model="ruleForm.shujifenlei" placeholder="请选择书籍分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="书籍分类" prop="shujifenlei">
	      <el-input v-model="ruleForm.shujifenlei"
                placeholder="书籍分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="书籍简介" prop="shujijianjie">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.shujijianjie" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shujijianjie" label="书籍简介" prop="shujijianjie">
                    <span v-html="ruleForm.shujijianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	alllimittimes : false,
      ...
      rules: {
          ...
          shujifenlei: [
                { required: true, message: '书籍分类不能为空', trigger: 'blur' },
          ],
          tupian: [
  ...
  methods: {
	...
	this.ruleForm.shujijianjie = this.ruleForm.shujijianjie.replace(reg,'../../../nodejsjn44t/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
